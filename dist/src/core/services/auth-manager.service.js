...
var AuthManagerService = /** @class */ (function () {
    function AuthManagerService(usersRepository) {
        this.usersRepository = usersRepository;
    }
    AuthManagerService.prototype.verificarCorreo = function (correo) {
    ...
    AuthManagerService.prototype.encriptarPassWord = function (password) {
        return __awaiter(this, void 0, void 0, function () {
            var salt;
            return __generator(this, function (_a) {
                switch (_a.label) {
