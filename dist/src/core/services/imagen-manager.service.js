...
exports.ImagenManagerService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const Usuario_1 = require("../../entities/Usuario");
const imagen_receta_repository_1 = require("../repositories/imagen-receta.repository");
const fs = require('fs');
let ImagenManagerService = class ImagenManagerService {
    constructor(usersRepository, imagenRecetasRepository) {
...
ImagenManagerService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(Usuario_1.Usuario)),
    __param(1, typeorm_1.InjectRepository(imagen_receta_repository_1.ImagenRecetaRepository)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        imagen_receta_repository_1.ImagenRecetaRepository])
], ImagenManagerService);
exports.ImagenManagerService = ImagenManagerService;
//# sourceMappingURL=imagen-manager.service.js.map