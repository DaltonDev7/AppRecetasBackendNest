...
var RolService = /** @class */ (function () {
    function RolService(rolRepository) {
        this.rolRepository = rolRepository;
    }
    RolService.prototype.create = function (rol) {
        return __awaiter(this, void 0, void 0, function () {
            var isExist, newRol;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rolRepository.findOne({
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.rolRepository.create(rol)];
                    case 2:
                        newRol = _a.sent();
                        return [4 /*yield*/, this.rolRepository.save(newRol)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RolService.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.rolRepository.find()];
