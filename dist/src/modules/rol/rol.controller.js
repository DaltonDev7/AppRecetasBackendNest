...
var Rol_1 = require("../../entities/Rol");
var RolController = /** @class */ (function () {
    function RolController(rolService) {
        this.rolService = rolService;
    }
    RolController.prototype.GetAll = function (res) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.rolService.getAll()];
    ...
    RolController.prototype.GetById = function (id, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, error_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
                        _b = (_a = res.status(200)).json;
                        return [4 /*yield*/, this.rolService.getById(id)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                    case 2:
                        error_2 = _c.sent();
                        return [2 /*return*/, res.status(500).json({
    ...
    RolController.prototype.Save = function (rol, res) {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.rolService.create(rol).then(function () {
