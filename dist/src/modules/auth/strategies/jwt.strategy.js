...
var JwtStrategyService = /** @class */ (function (_super) {
    __extends(JwtStrategyService, _super);
    function JwtStrategyService(usersRepository) {
    ...
    JwtStrategyService.prototype.validate = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findOne({ Email: data.Email })];
                    case 1:
                        user = _a.sent();
                        if (!user)
