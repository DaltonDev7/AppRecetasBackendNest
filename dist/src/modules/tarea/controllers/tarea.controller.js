...
let TareaController = class TareaController {
    ...
    getTareas(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return res.status(200).json(yield this.tareaService.getAll());
            }
            catch (error) {
    ...
    GetByIdUsuario(id, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return res.status(200).json(yield this.tareaService.getTareaByIdUsuario(id));
            }
            catch (error) {
                return res.status(500).json({
                    msg: 'Ha ocurrido un error',
    ...
    Save(tarea, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log(tarea);
                yield this.tareaService.save(tarea).then(() => {
    ...
    Delete(id, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.tareaService.delete(id).then(() => {
                    return res.json({
                        msg: 'Tarea Eliminado'
                    });
                });
